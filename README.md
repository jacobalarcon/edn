...
**[Download EDN for macOS →](https://github.com/jacobalarcon/edn/releases/download/v0.1.0-beta.4/EDN-0.1.0-beta.4.dmg)** · macOS 13+ · Apple Silicon and Intel
...
**[Download EDN for macOS (.dmg)](https://github.com/jacobalarcon/edn/releases/download/v0.1.0-beta.4/EDN-0.1.0-beta.4.dmg)**
